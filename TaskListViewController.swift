...
class TaskListViewController: UIViewController {
    ...
    @IBAction func didTapNewTaskButton(_ sender: Any) {
        performSegue(withIdentifier: "ComposeSegue", sender: nil)   // ... FOCUS here ... the sender is nill
    }
...
extension TaskListViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        // 3.
        performSegue(withIdentifier: "ComposeSegue", sender: selectedTask)     // FOCUS here the sender is selectedTask
    }
}
